    ...
    process
      ...
      type pattern_array is array (natural range <>) of pattern_type;
        constant patterns : pattern_array := (
			...
			-- or test
				(x"00000001", x"00000002", x"00000003", '0', "001"),
				(x"FFFFFF00", x"000000FF", x"FFFFFFFF", '0', "001"),
				(x"00000000", x"00000000", x"00000000", '1', "001"),
				(x"F0000000", x"00000000", x"F0000000", '0', "001"),
				
			-- and test
				(x"00000001", x"00000002", x"00000000", '1', "000"),
				(x"FFFFFF00", x"000000FF", x"00000000", '1', "000"),
				(x"00000000", x"00000000", x"00000000", '1', "000"),
				(x"F00E0F00", x"F0000000", x"F0000000", '0', "000")
		);
	begin
		--  Check each pattern.
